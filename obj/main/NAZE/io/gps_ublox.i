...
static uint8_t gpsMapFixType(_Bool fixValid, uint8_t ubloxFixType)
{
...
static _Bool gpsParceFrameUBLOX(void)
{
    switch (_msg_id) {
    case MSG_POSLLH:
...
static _Bool gpsConfigure(void)
{
...
static _Bool gpsCheckVersion(void)
{
# 702 "./src/main/io/gps_ublox.c"
...
static _Bool gpsReceiveData(void)
{
    _Bool hasNewData = 0;
...
static _Bool gpsInitialize(void)
{
    gpsSetState(GPS_CHANGE_BAUD);
    return 0;
}

static _Bool gpsChangeBaud(void)
{
...
_Bool gpsHandleUBLOX(void)
{

    _Bool hasNewData = gpsReceiveData();
