...
_Bool isSerialConfigValid(const serialConfig_t *serialConfigToCheck)
{
    ...
    for (int index = 0; index < 4; index++) {
        ...
        if (bitCount > 1) {
            ...
            if ((portConfig->functionMask & FUNCTION_MSP) && (portConfig->functionMask & (FUNCTION_BLACKBOX | (FUNCTION_TELEMETRY_FRSKY | FUNCTION_TELEMETRY_HOTT | FUNCTION_TELEMETRY_SMARTPORT | FUNCTION_TELEMETRY_LTM | FUNCTION_TELEMETRY_MAVLINK | FUNCTION_TELEMETRY_IBUS)))) {
    ...
    portOptions_t options)
{
    ...
    switch (identifier) {
        ...
        case SERIAL_PORT_USART1:
            serialPort = uartOpen(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)), rxCallback, baudRate, mode, options);
            break;


        case SERIAL_PORT_USART2:
            serialPort = uartOpen(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)), rxCallback, baudRate, mode, options);
            break;
# 393 "./src/main/io/serial.c"
