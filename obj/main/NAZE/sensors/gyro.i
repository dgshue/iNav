...
static gyroCalibration_t gyroCalibration;
static int32_t gyroADC[3];
...
const gyroConfig_t pgResetTemplate_gyroConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .gyro_lpf = 3, .gyro_soft_lpf_hz = 60, .gyro_align = ALIGN_DEFAULT, .gyroMovementCalibrationThreshold = 32, .looptime = 2000, .gyroSync = 0, .gyroSyncDenominator = 2, .gyro_to_use = 0, .gyro_soft_notch_hz_1 = 0, .gyro_soft_notch_cutoff_1 = 1, .gyro_soft_notch_hz_2 = 0, .gyro_soft_notch_cutoff_2 = 1 }
# 111 "./src/main/sensors/gyro.c"
 ;
...
static const extiConfig_t *selectMPUIntExtiConfig(void)
{
    ...
    static const extiConfig_t mpuIntExtiConfig = { .tag = ((((2) + 1) << 4) | (13)) };
    return &mpuIntExtiConfig;
# 132 "./src/main/sensors/gyro.c"
    return ((void *)0);
...
static gyroSensor_e gyroDetect(gyroDev_t *dev, gyroSensor_e gyroHardware)
{
    ...
    case GYRO_MPU6050:
        if (mpu6050GyroDetect(dev)) {
            ...
            dev->gyroAlign = CW0_DEG;

            break;
        }
# 221 "./src/main/sensors/gyro.c"
    case GYRO_MPU6500:
...
_Bool gyroInit(void)
{
    ...
    gyroDev0.bus.spi.csnPin = ((IO_t)0);
...
static _Bool isCalibrationComplete(gyroCalibration_t *gyroCalibration)
{
...
static _Bool isOnFinalGyroCalibrationCycle(gyroCalibration_t *gyroCalibration)
{
    return gyroCalibration->calibratingG == 1;
}

static _Bool isOnFirstGyroCalibrationCycle(gyroCalibration_t *gyroCalibration)
{
