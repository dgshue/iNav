...
# 28 "./src/main/sensors/rangefinder.c" 2
...
# 1 "./src/main/drivers/rangefinder_hcsr04.h" 1
# 18 "./src/main/drivers/rangefinder_hcsr04.h"
...
# 21 "./src/main/drivers/rangefinder_hcsr04.h" 2

#define RANGEFINDER_HCSR04_TASK_PERIOD_MS 70

_Bool hcsr04Detect(rangefinderDev_t *dev, const rangefinderHardwarePins_t * rangefinderHardwarePins);
# 39 "./src/main/sensors/rangefinder.c" 2
# 1 "./src/main/drivers/rangefinder_srf10.h" 1
# 18 "./src/main/drivers/rangefinder_srf10.h"
       

#define RANGEFINDER_SRF10_TASK_PERIOD_MS 70

_Bool srf10Detect(rangefinderDev_t *dev);
# 40 "./src/main/sensors/rangefinder.c" 2
# 1 "./src/main/drivers/rangefinder_hcsr04_i2c.h" 1
# 18 "./src/main/drivers/rangefinder_hcsr04_i2c.h"
       

#define RANGEFINDER_HCSR04_i2C_TASK_PERIOD_MS 100

_Bool hcsr04i2c0Detect(rangefinderDev_t *dev);
# 41 "./src/main/sensors/rangefinder.c" 2
# 1 "./src/main/drivers/rangefinder_vl53l0x.h" 1
# 25 "./src/main/drivers/rangefinder_vl53l0x.h"
       

#define RANGEFINDER_VL53L0X_TASK_PERIOD_MS 33

_Bool vl53l0xDetect(rangefinderDev_t *dev);
