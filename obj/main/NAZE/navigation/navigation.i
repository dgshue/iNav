...
# 33 "./src/main/navigation/navigation.c" 2
...
# 47 "./src/main/navigation/navigation.c" 2
...
# 50 "./src/main/navigation/navigation.c" 2
...
typedef struct navigationFlags_s {
    _Bool horizontalPositionDataNew;
    _Bool verticalPositionDataNew;
    _Bool surfaceDistanceDataNew;
    _Bool headingDataNew;

    _Bool horizontalPositionDataConsumed;
    _Bool verticalPositionDataConsumed;

    _Bool hasValidAltitudeSensor;
    _Bool hasValidPositionSensor;
    _Bool hasValidSurfaceSensor;
    _Bool hasValidHeadingSensor;

    _Bool isAdjustingPosition;
    _Bool isAdjustingAltitude;
    _Bool isAdjustingHeading;


    _Bool isGCSAssistedNavigationEnabled;
    _Bool isGCSAssistedNavigationReset;
    _Bool isTerrainFollowEnabled;

    _Bool forcedRTHActivated;
} navigationFlags_t;
...
typedef struct {
    ...
    navWaypoint_t waypointList[30];
    _Bool waypointListValid;
...
_Bool isThrustFacingDownwards(void);
...
_Bool isWaypointReached(const navWaypointPosition_t * waypoint, const _Bool isWaypointHome);
_Bool isWaypointMissed(const navWaypointPosition_t * waypoint);
_Bool isApproachingLastWaypoint(void);
float getActiveWaypointSpeed(void);

void updateActualHeading(int32_t newHeading);
void updateActualHorizontalPositionAndVelocity(_Bool hasValidSensor, float newX, float newY, float newVelX, float newVelY);
void updateActualAltitudeAndClimbRate(_Bool hasValidSensor, float newAltitude, float newVelocity);
void updateActualSurfaceDistance(_Bool hasValidSensor, float surfaceDistance, float surfaceVelocity);

_Bool checkForPositionSensorTimeout(void);
...
_Bool adjustMulticopterAltitudeFromRCInput(void);
_Bool adjustMulticopterHeadingFromRCInput(void);
_Bool adjustMulticopterPositionFromRCInput(void);
...
_Bool isMulticopterLandingDetected(void);
_Bool isFixedWingLandingDetected(void);
...
_Bool adjustFixedWingAltitudeFromRCInput(void);
_Bool adjustFixedWingHeadingFromRCInput(void);
_Bool adjustFixedWingPositionFromRCInput(void);
...
_Bool isFixedWingLaunchDetected(void);
void enableFixedWingLaunchController(timeUs_t currentTimeUs);
_Bool isFixedWingLaunchFinishedOrAborted(void);
...
# 53 "./src/main/navigation/navigation.c" 2
...
extern const navConfig_t pgResetTemplate_navConfig; navConfig_t navConfig_System; navConfig_t navConfig_Copy; extern const pgRegistry_t navConfig_Registry; const pgRegistry_t navConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 1002 | (1 << 12), .size = sizeof(navConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&navConfig_System, .copy = (uint8_t*)&navConfig_Copy, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_navConfig}, };

const navConfig_t pgResetTemplate_navConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .general = { .flags = { .use_thr_mid_for_althold = 0, .extra_arming_safety = 1, .user_control_mode = NAV_GPS_ATTI, .rth_alt_control_mode = NAV_RTH_AT_LEAST_ALT, .rth_climb_first = 1, .rth_climb_ignore_emerg = 0, .rth_tail_first = 0, .disarm_on_landing = 0, .rth_allow_landing = 1, }, .pos_failure_timeout = 5, .waypoint_radius = 100, .waypoint_safe_distance = 10000, .max_auto_speed = 300, .max_auto_climb_rate = 500, .max_manual_speed = 500, .max_manual_climb_rate = 200, .land_descent_rate = 200, .land_slowdown_minalt = 500, .land_slowdown_maxalt = 2000, .emerg_descent_rate = 500, .min_rth_distance = 500, .rth_altitude = 1000, .rth_abort_threshold = 50000, }, .mc = { .max_bank_angle = 30, .hover_throttle = 1500, .auto_disarm_delay = 2000, }, .fw = { .max_bank_angle = 20, .max_climb_angle = 20, .max_dive_angle = 15, .cruise_throttle = 1400, .max_throttle = 1700, .min_throttle = 1200, .pitch_to_throttle = 10, .loiter_radius = 5000, .land_dive_angle = 2, .launch_velocity_thresh = 300, .launch_accel_thresh = 1.9f * 981, .launch_time_thresh = 40, .launch_throttle = 1700, .launch_idle_throttle = 1000, .launch_motor_timer = 500, .launch_motor_spinup_time = 100, .launch_timeout = 5000, .launch_climb_angle = 18, .launch_max_angle = 45 } }
# 137 "./src/main/navigation/navigation.c"
 ;
...
_Bool validateRTHSanityChecker(void);
...
static const navigationFSMStateDescriptor_t navFSM[NAV_STATE_COUNT] = {
    ...
    [NAV_STATE_POSHOLD_2D_IN_PROGRESS] = {
        ...
        .mwError = MW_NAV_ERROR_NONE,
        .onEvent = {
            [NAV_FSM_EVENT_TIMEOUT] = NAV_STATE_POSHOLD_2D_IN_PROGRESS,
            [NAV_FSM_EVENT_SWITCH_TO_IDLE] = NAV_STATE_IDLE,
            [NAV_FSM_EVENT_SWITCH_TO_ALTHOLD] = NAV_STATE_ALTHOLD_INITIALIZE,
            [NAV_FSM_EVENT_SWITCH_TO_POSHOLD_3D] = NAV_STATE_POSHOLD_3D_INITIALIZE,
            [NAV_FSM_EVENT_SWITCH_TO_RTH] = NAV_STATE_RTH_INITIALIZE,
...
static navigationFSMEvent_t navOnEnteringState_NAV_STATE_RTH_INITIALIZE(navigationFSMState_t previousState)
{
    ...
    if (!posControl.flags.hasValidHeadingSensor || !posControl.flags.hasValidAltitudeSensor || !(stateFlags & (GPS_FIX_HOME))) {
...
static navigationFSMEvent_t navOnEnteringState_NAV_STATE_RTH_CLIMB_TO_SAFE_ALT(navigationFSMState_t previousState)
{
    ...
    if (posControl.flags.hasValidPositionSensor || !checkForPositionSensorTimeout() || navConfig()->general.flags.rth_climb_ignore_emerg) {
        const float rthAltitudeMargin = (stateFlags & (FIXED_WING)) ?
                            ( __extension__ ({ __typeof__(100.0f) _left1 = (100.0f); __typeof__(0.10f * ( __extension__ ({ __typeof__(posControl.homeWaypointAbove.pos.V.Z - posControl.homePosition.pos.V.Z) _abs0 = (posControl.homeWaypointAbove.pos.V.Z - posControl.homePosition.pos.V.Z); _abs0 < 0 ? -_abs0 : _abs0; }))) _right2 = (0.10f * ( __extension__ ({ __typeof__(posControl.homeWaypointAbove.pos.V.Z - posControl.homePosition.pos.V.Z) _abs0 = (posControl.homeWaypointAbove.pos.V.Z - posControl.homePosition.pos.V.Z); _abs0 < 0 ? -_abs0 : _abs0; }))); _left1 < _right2 ? _left1 : _right2; })) :
                            ( __extension__ ({ __typeof__(50.0f) _left4 = (50.0f); __typeof__(0.05f * ( __extension__ ({ __typeof__(posControl.homeWaypointAbove.pos.V.Z - posControl.homePosition.pos.V.Z) _abs3 = (posControl.homeWaypointAbove.pos.V.Z - posControl.homePosition.pos.V.Z); _abs3 < 0 ? -_abs3 : _abs3; }))) _right5 = (0.05f * ( __extension__ ({ __typeof__(posControl.homeWaypointAbove.pos.V.Z - posControl.homePosition.pos.V.Z) _abs3 = (posControl.homeWaypointAbove.pos.V.Z - posControl.homePosition.pos.V.Z); _abs3 < 0 ? -_abs3 : _abs3; }))); _left4 < _right5 ? _left4 : _right5; }));
...
static navigationFSMEvent_t navOnEnteringState_NAV_STATE_RTH_HEAD_HOME(navigationFSMState_t previousState)
{
    ...
    if (posControl.flags.hasValidPositionSensor) {
        if (isWaypointReached(&posControl.homeWaypointAbove, 1)) {
...
static navigationFSMEvent_t navOnEnteringState_NAV_STATE_WAYPOINT_IN_PROGRESS(navigationFSMState_t previousState)
{
    ...
    if (posControl.flags.hasValidPositionSensor && posControl.flags.hasValidHeadingSensor) {
        const _Bool isDoingRTH = (posControl.waypointList[posControl.activeWaypointIndex].action == NAV_WP_ACTION_RTH);
...
static navigationFSMEvent_t navOnEnteringState_NAV_STATE_WAYPOINT_NEXT(navigationFSMState_t previousState)
{
    ...
    const _Bool isLastWaypoint = (posControl.waypointList[posControl.activeWaypointIndex].flag == NAV_WP_FLAG_LAST) ||
...
static void navProcessFSMEvents(navigationFSMEvent_t injectedEvent)
{
    ...
    if ((posControl.activeWaypointIndex >= 0) && (posControl.activeWaypointIndex < 30)) {
...
void updateActualSurfaceDistance(_Bool hasValidSensor, float surfaceDistance, float surfaceVelocity)
{
    ...
    if (hasValidSensor) {
        posControl.flags.hasValidSurfaceSensor = 1;
    ...
    if ((armingFlags & (ARMED))) {
        if (hasValidSensor && posControl.actualState.surface > 0) {
            if (posControl.actualState.surfaceMin > 0) {
                posControl.actualState.surfaceMin = ( __extension__ ({ __typeof__(posControl.actualState.surfaceMin) _left13 = (posControl.actualState.surfaceMin); __typeof__(posControl.actualState.surface) _right14 = (posControl.actualState.surface); _left13 < _right14 ? _left13 : _right14; }));
            }
            else {
    ...
    if ((armingFlags & (ARMED))) {
        if (!(navGetStateFlags(posControl.navState) & NAV_AUTO_RTH)) {
            ...
            case NAV_RTH_MAX_ALT:
                posControl.homeWaypointAbove.pos.V.Z = ( __extension__ ({ __typeof__(posControl.homeWaypointAbove.pos.V.Z) _left16 = (posControl.homeWaypointAbove.pos.V.Z); __typeof__(posControl.actualState.pos.V.Z) _right17 = (posControl.actualState.pos.V.Z); _left16 > _right17 ? _left16 : _right17; }));
                break;
            case NAV_RTH_AT_LEAST_ALT:
                posControl.homeWaypointAbove.pos.V.Z = ( __extension__ ({ __typeof__(posControl.homePosition.pos.V.Z + navConfig()->general.rth_altitude) _left18 = (posControl.homePosition.pos.V.Z + navConfig()->general.rth_altitude); __typeof__(posControl.actualState.pos.V.Z) _right19 = (posControl.actualState.pos.V.Z); _left18 > _right19 ? _left18 : _right19; }));
                break;
...
void updateHomePosition(void)
{
    ...
    if (!(armingFlags & (ARMED))) {
        ...
        static _Bool isHomeResetAllowed = 0;


        if (IS_RC_MODE_ACTIVE(BOXHOMERESET)) {
            if (isHomeResetAllowed && !(flightModeFlags & (NAV_RTH_MODE)) && !(flightModeFlags & (NAV_WP_MODE)) && posControl.flags.hasValidPositionSensor) {
                ...
                isHomeResetAllowed = 0;
            }
        }
        else {
            isHomeResetAllowed = 1;
        }
...
{
    if (surfaceOffset > 0) {
        posControl.desiredState.surface = constrainf(surfaceOffset, 1.0f, 40);
    }
    else {
...
void calculateFarAwayTarget(t_fp_vector * farAwayPos, int32_t yaw, int32_t distance)
{
    farAwayPos->V.X = posControl.actualState.pos.V.X + distance * cos_approx((((yaw) / 100.0f) * (3.14159265358979323846f / 180.0f)));
    farAwayPos->V.Y = posControl.actualState.pos.V.Y + distance * sin_approx((((yaw) / 100.0f) * (3.14159265358979323846f / 180.0f)));
    ...
    if (mode == ROC_TO_ALT_RESET) {
        ...
        if ((stateFlags & (FIXED_WING))) {
            ...
            if (timeDelta <= (((1000000 / (5))) * 1e-6f)) {
                ...
                posControl.desiredState.pos.V.Z = constrainf(posControl.desiredState.pos.V.Z,
...
static _Bool adjustAltitudeFromRCInput(void)
{
    if ((stateFlags & (FIXED_WING))) {
...
static _Bool adjustHeadingFromRCInput(void)
{
    if ((stateFlags & (FIXED_WING))) {
...
static _Bool adjustPositionFromRCInput(void)
{
    _Bool retValue;
...
void resetGCSFlags(void)
{
    posControl.flags.isGCSAssistedNavigationReset = 0;
    posControl.flags.isGCSAssistedNavigationEnabled = 0;
}
...
void getWaypoint(uint8_t wpNumber, navWaypoint_t * wpData)
{
    ...
    else if ((wpNumber >= 1) && (wpNumber <= 30)) {
...
void setWaypoint(uint8_t wpNumber, const navWaypoint_t * wpData)
{
    ...
    if ((wpNumber == 0) && (armingFlags & (ARMED)) && posControl.flags.hasValidPositionSensor && posControl.gpsOrigin.valid && posControl.flags.isGCSAssistedNavigationEnabled) {
        ...
        setHomePosition(&wpPos.pos, 0, NAV_POS_UPDATE_XY | NAV_POS_UPDATE_Z | NAV_POS_UPDATE_HEADING);
             ...
             (armingFlags & (ARMED)) && posControl.flags.hasValidPositionSensor && posControl.gpsOrigin.valid && posControl.flags.isGCSAssistedNavigationEnabled &&
    ...
    else if ((wpNumber >= 1) && (wpNumber <= 30) && !(armingFlags & (ARMED))) {
...
void resetWaypointList(void)
{
    ...
    if (!(armingFlags & (ARMED))) {
        ...
        posControl.waypointListValid = 0;
    }
}
...
static void processNavigationRCAdjustments(void)
{
    ...
    if ((navStateFlags & NAV_RC_ALT) && (!(flightModeFlags & (FAILSAFE_MODE)))) {
        ...
        posControl.flags.isAdjustingAltitude = 0;
    }
    ...
    if ((navStateFlags & NAV_RC_POS) && (!(flightModeFlags & (FAILSAFE_MODE)))) {
        ...
        posControl.flags.isAdjustingPosition = 0;
    }
    ...
    if ((navStateFlags & NAV_RC_YAW) && (!(flightModeFlags & (FAILSAFE_MODE)))) {
        ...
        posControl.flags.isAdjustingHeading = 0;
    }
}
...
static _Bool canActivateAltHoldMode(void)
{
    return posControl.flags.hasValidAltitudeSensor;
}

static _Bool canActivatePosHoldMode(void)
{
...
{
    static _Bool canActivateWaypoint = 0;
    static _Bool canActivateLaunchMode = 0;


    if ((armingFlags & (ARMED))) {

        _Bool canActivateAltHold = canActivateAltHoldMode();
        _Bool canActivatePosHold = canActivatePosHoldMode();


        if ((stateFlags & (FIXED_WING))) {
            if (IS_RC_MODE_ACTIVE(BOXNAVLAUNCH)) {
                if (canActivateLaunchMode) {
                    canActivateLaunchMode = 0;
        ...
        if (posControl.flags.forcedRTHActivated || (IS_RC_MODE_ACTIVE(BOXNAVRTH) && canActivatePosHold && canActivateAltHold && (stateFlags & (GPS_FIX_HOME)))) {


            canActivateWaypoint = 0;
        ...
        if (IS_RC_MODE_ACTIVE(BOXNAVWP)) {
            if (((flightModeFlags & (NAV_WP_MODE))) || (canActivateWaypoint && canActivatePosHold && canActivateAltHold && (stateFlags & (GPS_FIX_HOME)) && (armingFlags & (ARMED)) && posControl.waypointListValid && (posControl.waypointCount > 0)))
                return NAV_FSM_EVENT_SWITCH_TO_WAYPOINT;
        }
        else {

            canActivateWaypoint = 1;
        }

        if (IS_RC_MODE_ACTIVE(BOXNAVPOSHOLD) && IS_RC_MODE_ACTIVE(BOXNAVALTHOLD)) {
            if (((flightModeFlags & (NAV_ALTHOLD_MODE)) && (flightModeFlags & (NAV_POSHOLD_MODE))) || (canActivatePosHold && canActivateAltHold))
                return NAV_FSM_EVENT_SWITCH_TO_POSHOLD_3D;
        }

        if (IS_RC_MODE_ACTIVE(BOXNAVPOSHOLD)) {
            if (((flightModeFlags & (NAV_POSHOLD_MODE))) || (canActivatePosHold))
...
_Bool navigationBlockArming(void)
{
    const _Bool navBoxModesEnabled = IS_RC_MODE_ACTIVE(BOXNAVRTH) || IS_RC_MODE_ACTIVE(BOXNAVWP) || IS_RC_MODE_ACTIVE(BOXNAVPOSHOLD);
    const _Bool navLaunchComboModesEnabled = IS_RC_MODE_ACTIVE(BOXNAVLAUNCH) && (IS_RC_MODE_ACTIVE(BOXNAVRTH) || IS_RC_MODE_ACTIVE(BOXNAVWP));
    _Bool shouldBlockArming = 0;

    if (!navConfig()->general.flags.extra_arming_safety)
        return 0;


    if ((isUsingNavigationModes() || failsafeMayRequireNavigationMode()) && !(posControl.flags.hasValidPositionSensor && (stateFlags & (GPS_FIX_HOME)))) {
        shouldBlockArming = 1;
    }
    ...
    if (posControl.waypointCount > 0) {
        ...
        const _Bool navWpMissionStartTooFar = calculateDistanceToDestination(&startingWaypointPos) > navConfig()->general.waypoint_safe_distance;
...
_Bool navigationPositionEstimateIsHealthy(void)
{
    return posControl.flags.hasValidPositionSensor && (stateFlags & (GPS_FIX_HOME));
}
...
{
    static _Bool posReadyBeepDone = 0;
...
void updateFlightBehaviorModifiers(void)
{
    if (posControl.flags.isGCSAssistedNavigationEnabled && !IS_RC_MODE_ACTIVE(BOXGCSNAV)) {
        posControl.flags.isGCSAssistedNavigationReset = 1;
    }
...
void activateForcedRTH(void)
{
    posControl.flags.forcedRTHActivated = 1;
    navProcessFSMEvents(selectNavEventFromBoxModeInput());
}
