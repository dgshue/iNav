...
# 84 "./src/main/blackbox/blackbox.c"
...
const blackboxConfig_t pgResetTemplate_blackboxConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .device = BLACKBOX_DEVICE_SERIAL, .rate_num = 1, .rate_denom = 1, .invertedCardDetection = 0, }
...
static const blackboxDeltaFieldDefinition_t blackboxMainFields[] = {
    ...
    {"navTgtSurf", 0, FLIGHT_LOG_FIELD_SIGNED, .Ipredict = FLIGHT_LOG_FIELD_PREDICTOR_0, .Iencode = FLIGHT_LOG_FIELD_ENCODING_SIGNED_VB, .Ppredict = FLIGHT_LOG_FIELD_PREDICTOR_PREVIOUS, .Pencode = FLIGHT_LOG_FIELD_ENCODING_SIGNED_VB, FLIGHT_LOG_FIELD_CONDITION_ALWAYS},
...
static _Bool blackboxIsOnlyLoggingIntraframes(void)
{
...
# 647 "./src/main/blackbox/blackbox.c"
...
# 816 "./src/main/blackbox/blackbox.c"
    if (testBlackboxCondition(FLIGHT_LOG_FIELD_CONDITION_RSSI)) {
    ...
    blackboxWriteMainStateArrayUsingAveragePredictor(__builtin_offsetof (blackboxMainState_t, accADC), 3);
    blackboxWriteMainStateArrayUsingAveragePredictor(__builtin_offsetof (blackboxMainState_t, attitude), 3);
    if (testBlackboxCondition(FLIGHT_LOG_FIELD_CONDITION_DEBUG)) {
        blackboxWriteMainStateArrayUsingAveragePredictor(__builtin_offsetof (blackboxMainState_t, debug), 4);
    }
    blackboxWriteMainStateArrayUsingAveragePredictor(__builtin_offsetof (blackboxMainState_t, motor), getMotorCount());
...
static _Bool writeSlowFrameIfNeeded(_Bool allowPeriodicWrite)
{

    _Bool shouldWrite = allowPeriodicWrite && blackboxSlowFrameIterationTimer >= blackboxSInterval;
...
# 1020 "./src/main/blackbox/blackbox.c"
...
static void writeGPSFrame(timeUs_t currentTimeUs)
{
    ...
    blackboxWriteUnsignedVB(gpsSol.llh.alt / 100);
...
# 1157 "./src/main/blackbox/blackbox.c"
...
# 1310 "./src/main/blackbox/blackbox.c"
static _Bool blackboxWriteSysinfo(void)
{
    ...
    switch (xmitState.headerIndex) {
        ...
        case 1: blackboxPrintfHeaderLine("Firmware revision", "INAV %s (%s) %s", "1" "." "7" "." "3", shortGitRevision, targetName); break;;
...
# 1330 "./src/main/blackbox/blackbox.c"
        : {if (testBlackboxCondition(FLIGHT_LOG_FIELD_CONDITION_VBAT)) { blackboxPrintfHeaderLine("vbat_scale", "%u", batteryConfig()->vbatscale); } else { xmitState.headerIndex += 2; }}; break;
 ...
 12
# 1337 "./src/main/blackbox/blackbox.c"
 ...
 14
# 1342 "./src/main/blackbox/blackbox.c"
        : {if (feature(FEATURE_CURRENT_METER)) { blackboxPrintfHeaderLine("currentMeter", "%d,%d", batteryConfig()->currentMeterOffset, batteryConfig()->currentMeterScale); }}; break;
        ...
        case 16: blackboxPrintfHeaderLine("gyro_sync_denom", "%d", gyroConfig()->gyroSyncDenominator); break;;
        case 17: blackboxPrintfHeaderLine("rc_rate", "%d", 100); break;;
        case 18: blackboxPrintfHeaderLine("rc_expo", "%d", currentControlRateProfile->rcExpo8); break;;
        case 19: blackboxPrintfHeaderLine("rc_yaw_expo", "%d", currentControlRateProfile->rcYawExpo8); break;;
 ...
 24
# 1359 "./src/main/blackbox/blackbox.c"
 ...
 25
# 1362 "./src/main/blackbox/blackbox.c"
 ...
 26
# 1365 "./src/main/blackbox/blackbox.c"
 ...
 27
# 1368 "./src/main/blackbox/blackbox.c"
 ...
 28
# 1371 "./src/main/blackbox/blackbox.c"
 ...
 29
# 1374 "./src/main/blackbox/blackbox.c"
 ...
 30
# 1377 "./src/main/blackbox/blackbox.c"
 ...
 31
# 1380 "./src/main/blackbox/blackbox.c"
        : blackboxPrintfHeaderLine("levelPID", "%d,%d,%d", pidBank()->pid[PID_LEVEL].P, pidBank()->pid[PID_LEVEL].I, pidBank()->pid[PID_LEVEL].D); break;

                                                                                                        ;
        case 32: blackboxPrintfHeaderLine("magPID", "%d", pidBank()->pid[PID_HEADING].P); break;;
        case

 33
# 1384 "./src/main/blackbox/blackbox.c"
        : blackboxPrintfHeaderLine("velPID", "%d,%d,%d", pidBank()->pid[PID_VEL_Z].P, pidBank()->pid[PID_VEL_Z].I, pidBank()->pid[PID_VEL_Z].D); break;

                                                                                                        ;
        case 34: blackboxPrintfHeaderLine("yaw_p_limit", "%d", pidProfile()->yaw_p_limit); break;;
        case 35: blackboxPrintfHeaderLine("yaw_lpf_hz", "%d", pidProfile()->yaw_lpf_hz); break;;
        case 36: blackboxPrintfHeaderLine("dterm_lpf_hz", "%d", pidProfile()->dterm_lpf_hz); break;;
        case 37: blackboxPrintfHeaderLine("dterm_notch_hz", "%d", pidProfile()->dterm_soft_notch_hz); break;;
        case 38: blackboxPrintfHeaderLine("dterm_notch_cutoff", "%d", pidProfile()->dterm_soft_notch_cutoff); break;;
        case 39: blackboxPrintfHeaderLine("deadband", "%d", rcControlsConfig()->deadband); break;;
        case 40: blackboxPrintfHeaderLine("yaw_deadband", "%d", rcControlsConfig()->yaw_deadband); break;;
        case 41: blackboxPrintfHeaderLine("gyro_lpf", "%d", gyroConfig()->gyro_lpf); break;;
        case 42: blackboxPrintfHeaderLine("gyro_lpf_hz", "%d", gyroConfig()->gyro_soft_lpf_hz); break;;
        case
 43
# 1396 "./src/main/blackbox/blackbox.c"
...
# 1398 "./src/main/blackbox/blackbox.c"
        : blackboxPrintfHeaderLine("gyro_notch_cutoff", "%d,%d", gyroConfig()->gyro_soft_notch_cutoff_1, gyroConfig()->gyro_soft_notch_cutoff_2); break;
                                                                                                                   ;
        case 45: blackboxPrintfHeaderLine("acc_lpf_hz", "%d", pidProfile()->acc_soft_lpf_hz); break;;
        case 46: blackboxPrintfHeaderLine("acc_hardware", "%d", accelerometerConfig()->acc_hardware); break;;
        case 47: blackboxPrintfHeaderLine("baro_hardware", "%d", barometerConfig()->baro_hardware); break;;
        case 48: blackboxPrintfHeaderLine("mag_hardware", "%d", compassConfig()->mag_hardware); break;;
        case 49: blackboxPrintfHeaderLine("serialrx_provider", "%d", rxConfig()->serialrx_provider); break;;
        case 50: blackboxPrintfHeaderLine("motor_pwm_protocol", "%d", motorConfig()->motorPwmProtocol); break;;
        case 51: blackboxPrintfHeaderLine("motor_pwm_rate", "%d", motorConfig()->motorPwmRate); break;;
        case 52: blackboxPrintfHeaderLine("debug_mode", "%d", systemConfig()->debug_mode); break;;
        case 53: blackboxPrintfHeaderLine("features", "%d", featureConfig()->enabledFeatures); break;;
...
static _Bool blackboxShouldLogIFrame(void)
{
