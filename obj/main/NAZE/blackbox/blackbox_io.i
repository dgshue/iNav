...
# 79 "./src/main/blackbox/blackbox_io.c"
void blackboxOpen()
{
...
int blackboxPrint(const char *s)
{
    ...
    case BLACKBOX_DEVICE_FLASH:
        ...
        break;
# 130 "./src/main/blackbox/blackbox_io.c"
    case BLACKBOX_DEVICE_SERIAL:
    default:
        pos = (uint8_t*) s;
        while (*pos) {
...
# 193 "./src/main/blackbox/blackbox_io.c"
    default:
        return 0;
    }
}
    ...
    case BLACKBOX_DEVICE_SERIAL:
        {
            ...
            blackboxPort = openSerialPort(portConfig->identifier, FUNCTION_BLACKBOX, ((void *)0), baudRates[baudRateIndex],
                MODE_TX, portOptions);
# 241 "./src/main/blackbox/blackbox_io.c"
...
# 435 "./src/main/blackbox/blackbox_io.c"
_Bool blackboxDeviceBeginLog(void)
{
    switch (blackboxConfig()->device) {
...
_Bool blackboxDeviceEndLog(_Bool retainLog)
{
    ...
    switch (blackboxConfig()->device) {
# 476 "./src/main/blackbox/blackbox_io.c"
    default:
        return 1;
    }
}
...
# 549 "./src/main/blackbox/blackbox_io.c"
blackboxBufferReserveStatus_e blackboxDeviceReserveBufferSpace(int32_t bytes)
{
    ...
    case BLACKBOX_DEVICE_FLASH:
        ...
        return BLACKBOX_RESERVE_TEMPORARY_FAILURE;
# 592 "./src/main/blackbox/blackbox_io.c"
    default:
        return BLACKBOX_RESERVE_PERMANENT_FAILURE;
    }
}
