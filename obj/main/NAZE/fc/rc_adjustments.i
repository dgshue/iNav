...
# 201 "./src/main/fc/rc_adjustments.c"
static void applyStepAdjustment(controlRateConfig_t *controlRateConfig, uint8_t adjustmentFunction, int delta)
{
    ...
    switch (adjustmentFunction) {
        ...
        case ADJUSTMENT_PITCH_RATE:
            newValue = constrain((int)controlRateConfig->rates[FD_PITCH] + delta, 6, 180);
        ...
        case ADJUSTMENT_ROLL_RATE:
            newValue = constrain((int)controlRateConfig->rates[FD_ROLL] + delta, 6, 180);
            controlRateConfig->rates[FD_ROLL] = newValue;
            blackboxLogInflightAdjustmentEvent(ADJUSTMENT_ROLL_RATE, newValue);
            schedulePidGainsUpdate();
            break;
        case ADJUSTMENT_YAW_RATE:
            newValue = constrain((int)controlRateConfig->rates[FD_YAW] + delta, 2, 180);
        ...
        case ADJUSTMENT_PITCH_P:
            newValue = constrain((int)pidBank()->pid[PID_PITCH].P + delta, 0, 200);
        ...
        case ADJUSTMENT_ROLL_P:
            newValue = constrain((int)pidBank()->pid[PID_ROLL].P + delta, 0, 200);
        ...
        case ADJUSTMENT_PITCH_I:
            newValue = constrain((int)pidBank()->pid[PID_PITCH].I + delta, 0, 200);
        ...
        case ADJUSTMENT_ROLL_I:
            newValue = constrain((int)pidBank()->pid[PID_ROLL].I + delta, 0, 200);
        ...
        case ADJUSTMENT_PITCH_D:
            newValue = constrain((int)pidBank()->pid[PID_PITCH].D + delta, 0, 200);
        ...
        case ADJUSTMENT_ROLL_D:
            newValue = constrain((int)pidBank()->pid[PID_ROLL].D + delta, 0, 200);
            pidBankMutable()->pid[PID_ROLL].D = newValue;
            blackboxLogInflightAdjustmentEvent(ADJUSTMENT_ROLL_D, newValue);
            schedulePidGainsUpdate();
            break;
        case ADJUSTMENT_YAW_P:
            newValue = constrain((int)pidBank()->pid[PID_YAW].P + delta, 0, 200);
            pidBankMutable()->pid[PID_YAW].P = newValue;
            blackboxLogInflightAdjustmentEvent(ADJUSTMENT_YAW_P, newValue);
            schedulePidGainsUpdate();
            break;
        case ADJUSTMENT_YAW_I:
            newValue = constrain((int)pidBank()->pid[PID_YAW].I + delta, 0, 200);
            pidBankMutable()->pid[PID_YAW].I = newValue;
            blackboxLogInflightAdjustmentEvent(ADJUSTMENT_YAW_I, newValue);
            schedulePidGainsUpdate();
            break;
        case ADJUSTMENT_YAW_D:
            newValue = constrain((int)pidBank()->pid[PID_YAW].D + delta, 0, 200);
...
# 335 "./src/main/fc/rc_adjustments.c"
...
void processRcAdjustments(controlRateConfig_t *controlRateConfig)
{
    ...
    const _Bool canUseRxData = rxIsReceivingSignal();
    ...
    for (int adjustmentIndex = 0; adjustmentIndex < 4; adjustmentIndex++) {
        ...
        const _Bool canResetReadyStates = signedDiff >= 0L;
