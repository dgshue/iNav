...
{
    for (int i = 0; i < 3; i++) {
        static const const controlRateConfig_t _reset_template_51 = { .rcExpo8 = 70, .thrMid8 = 50, .thrExpo8 = 0, .dynThrPID = 0, .rcYawExpo8 = 20, .tpa_breakpoint = 1500, .rates[FD_ROLL] = 20, .rates[FD_PITCH] = 20, .rates[FD_YAW] = 20 }; memcpy((&instance[i]), &_reset_template_51, sizeof(*(&instance[i])));
# 51 "./src/main/fc/controlrate_profile.c"
         ;
    }
}
