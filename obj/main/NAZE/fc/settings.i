...
# 8 "./src/main/fc/settings.c" 2

# 1 "./src/main/fc/settings_generated.c" 1
...
# 2 "./src/main/fc/settings_generated.c" 2
...
# 3 "./src/main/fc/settings_generated.c" 2
...
# 8 "./src/main/fc/settings_generated.c" 2
...
# 9 "./src/main/fc/settings_generated.c" 2
...
# 10 "./src/main/fc/settings_generated.c" 2
...
# 11 "./src/main/fc/settings_generated.c" 2
...
# 12 "./src/main/fc/settings_generated.c" 2
...
# 13 "./src/main/fc/settings_generated.c" 2
...
# 14 "./src/main/fc/settings_generated.c" 2
...
# 15 "./src/main/fc/settings_generated.c" 2
...
# 16 "./src/main/fc/settings_generated.c" 2
...
# 17 "./src/main/fc/settings_generated.c" 2
...
# 18 "./src/main/fc/settings_generated.c" 2
...
# 19 "./src/main/fc/settings_generated.c" 2
...
void imuInit(void);
# 20 "./src/main/fc/settings_generated.c" 2
...
# 21 "./src/main/fc/settings_generated.c" 2
...
# 22 "./src/main/fc/settings_generated.c" 2
...
# 23 "./src/main/fc/settings_generated.c" 2
...
# 25 "./src/main/fc/settings_generated.c" 2
...
static const char *cliValueWords[] = {
 ((void *)0),
 "nav",
 "fw",
 "mc",
...
const char *table_aux_operator[] = {
 "OR",
 "AND",
};
const char *table_baro_hardware[] = {
 "NONE",
 "AUTO",
 "BMP085",
 "MS5611",
...
const char *table_blackbox_device[] = {
 "SERIAL",
 "SPIFLASH",
 "SDCARD",
};
const char *table_current_sensor[] = {
 "NONE",
 "ADC",
 "VIRTUAL",
};
const char *table_debug_modes[] = {
 "NONE",
 "GYRO",
 "NOTCH",
 "NAV_LANDING",
...
const char *table_failsafe_procedure[] = {
 "SET-THR",
 "DROP",
 "RTH",
 "NONE",
};
const char *table_frsky_unit[] = {
 "METRIC",
 "IMPERIAL",
};
const char *table_gimbal_mode[] = {
 "NORMAL",
 "MIXTILT",
};
const char *table_gps_dyn_model[] = {
 "PEDESTRIAN",
 "AIR_1G",
 "AIR_4G",
};
const char *table_gps_provider[] = {
 "NMEA",
 "UBLOX",
 "I2C-NAV",
 "NAZA",
...
const char *table_gps_sbas_mode[] = {
 "AUTO",
 "EGNOS",
 "WAAS",
 "MSAS",
...
const char *table_i2c_speed[] = {
 "400KHZ",
 "800KHZ",
 "100KHZ",
 "200KHZ",
};
const char *table_ltm_rates[] = {
 "NORMAL",
 "MEDIUM",
 "SLOW",
};
...
const char *table_nav_rth_alt_mode[] = {
 "CURRENT",
 "EXTRA",
 "FIXED",
 "MAX",
...
const char *table_nav_user_control_mode[] = {
 "ATTI",
 "CRUISE",
};
const char *table_off_on[] = {
 "OFF",
 "ON",
};
const char *table_reset_altitude[] = {
 "NEVER",
 "FIRST_ARM",
 "EACH_ARM",
};
const char *table_serial_rx[] = {
 "SPEK1024",
 "SPEK2048",
 "SBUS",
 "SUMD",
...
const lookupTableEntry_t cliLookupTables[] = {
...
typedef uint8_t clivalue_min_max_idx_t;
#define CLIVALUE_INDEXES_GET_MIN(val) (val->config.minmax.indexes[0])
...
const clivalue_t cliValueTable[] = {
 ...
 { {1, 2, 10, 12, 4}, VAR_UINT8 | PROFILE_VALUE, .config.minmax.indexes = {0, 3}, __builtin_offsetof (pidProfile_t, bank_fw.pid[PID_POS_XY].P) },
...
_Bool clivalue_name_contains(const clivalue_t *val, char *buf, const char *cmdline)
{
 ...
 return strstr(buf, cmdline) != ((void *)0);
}
...
clivalue_min_t clivalue_get_min(const clivalue_t *val)
{
 return cliValueMinMaxTable[(val->config.minmax.indexes[0])];
}

clivalue_max_t clivalue_get_max(const clivalue_t *val)
{
 return cliValueMinMaxTable[(val->config.minmax.indexes[1])];
}
