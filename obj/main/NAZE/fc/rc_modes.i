...
static _Bool isUsingNAVModes = 0;


boxBitmask_t rcModeActivationMask;
typedef char assert_failed_too_many_box_modes [(CHECKBOX_ITEM_COUNT <= 32) ? 1 : -1 ] __attribute__((unused));
