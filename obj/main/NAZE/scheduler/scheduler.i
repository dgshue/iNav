...
# 158 "./src/main/scheduler/scheduler.c"
void rescheduleTask(cfTaskId_e taskId, timeDelta_t newPeriodUs)
{
    if (taskId == TASK_SELF) {
...
void schedulerResetTaskStatistics(cfTaskId_e taskId)
{
    ...
    (void)(taskId);
# 207 "./src/main/scheduler/scheduler.c"
}
...
void scheduler(void)
{
    ...
    timeUs_t timeToNextRealtimeTask = (18446744073709551615ULL);
...
# 312 "./src/main/scheduler/scheduler.c"
    }
}
