...
# 75 "./src/main/drivers/bus_spi.c"
static spiDevice_t spiHardwareMap[] = {

    { .dev = ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3000)), .nss = ((((0) + 1) << 4) | (4)), .sck = ((((0) + 1) << 4) | (5)), .miso = ((((0) + 1) << 4) | (6)), .mosi = ((((0) + 1) << 4) | (7)), .rcc = (((RCC_APB2) << 5) | (16*((((uint32_t)0x00001000))>65535L) + (8*(((((uint32_t)0x00001000))*1L >>16*((((uint32_t)0x00001000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00001000))*1L >>16*((((uint32_t)0x00001000))>65535L)) >>8*(((((uint32_t)0x00001000))*1L >>16*((((uint32_t)0x00001000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00001000))*1L >>16*((((uint32_t)0x00001000))>65535L)) >>8*(((((uint32_t)0x00001000))*1L >>16*((((uint32_t)0x00001000))>65535L))>255))/2+1))))), .af = 0, 0 },
    { .dev = ((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)), .nss = ((((1) + 1) << 4) | (12)), .sck = ((((1) + 1) << 4) | (13)), .miso = ((((1) + 1) << 4) | (14)), .mosi = ((((1) + 1) << 4) | (15)), .rcc = (((RCC_APB1) << 5) | (16*((((uint32_t)0x00004000))>65535L) + (8*(((((uint32_t)0x00004000))*1L >>16*((((uint32_t)0x00004000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00004000))*1L >>16*((((uint32_t)0x00004000))>65535L)) >>8*(((((uint32_t)0x00004000))*1L >>16*((((uint32_t)0x00004000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00004000))*1L >>16*((((uint32_t)0x00004000))>65535L)) >>8*(((((uint32_t)0x00004000))*1L >>16*((((uint32_t)0x00004000))>65535L))>255))/2+1))))), .af = 0, 0 },
...
# 118 "./src/main/drivers/bus_spi.c"
...
# 141 "./src/main/drivers/bus_spi.c"
    ...
    if (spi->nss) {
        IOConfigGPIO(IOGetByTag(spi->nss), ((GPIO_Mode_Out_PP) | (GPIO_Speed_50MHz)));
    }
