...
# 29 "./src/main/drivers/serial_uart_stm32f10x.c" 2
...
# 31 "./src/main/drivers/serial_uart_stm32f10x.c" 2
...
# 96 "./src/main/drivers/serial_uart_stm32f10x.c"
uartPort_t *serialUART1(uint32_t baudRate, portMode_t mode, portOptions_t options)
{
    uartPort_t *s;
...
# 124 "./src/main/drivers/serial_uart_stm32f10x.c"
    ...
    RCC_ClockCmd((((RCC_AHB) << 5) | (16*((((uint16_t)0x0001))>65535L) + (8*(((((uint16_t)0x0001))*1L >>16*((((uint16_t)0x0001))>65535L))>255) + (8 - 90/(((((((uint16_t)0x0001))*1L >>16*((((uint16_t)0x0001))>65535L)) >>8*(((((uint16_t)0x0001))*1L >>16*((((uint16_t)0x0001))>65535L))>255))/4+14)|1) - 2/((((((uint16_t)0x0001))*1L >>16*((((uint16_t)0x0001))>65535L)) >>8*(((((uint16_t)0x0001))*1L >>16*((((uint16_t)0x0001))>65535L))>255))/2+1))))), ENABLE);



    if (options & SERIAL_BIDIR) {
        IOInit(IOGetByTag(((((0) + 1) << 4) | (9))), OWNER_SERIAL, RESOURCE_UART_TXRX, 1);
        IOConfigGPIO(IOGetByTag(((((0) + 1) << 4) | (9))), ((GPIO_Mode_AF_OD) | (GPIO_Speed_2MHz)));
    } else {
        if (mode & MODE_TX) {
            IOInit(IOGetByTag(((((0) + 1) << 4) | (9))), OWNER_SERIAL, RESOURCE_UART_TX, 1);
            IOConfigGPIO(IOGetByTag(((((0) + 1) << 4) | (9))), ((GPIO_Mode_AF_PP) | (GPIO_Speed_2MHz)));
        }

        if (mode & MODE_RX) {
            IOInit(IOGetByTag(((((0) + 1) << 4) | (10))), OWNER_SERIAL, RESOURCE_UART_RX, 1);
            IOConfigGPIO(IOGetByTag(((((0) + 1) << 4) | (10))), ((GPIO_Mode_IPU) | (GPIO_Speed_2MHz)));
        }
    }
# 151 "./src/main/drivers/serial_uart_stm32f10x.c"
...
# 201 "./src/main/drivers/serial_uart_stm32f10x.c"
    RCC_ClockCmd((((RCC_APB1) << 5) | (16*((((uint32_t)0x00020000))>65535L) + (8*(((((uint32_t)0x00020000))*1L >>16*((((uint32_t)0x00020000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00020000))*1L >>16*((((uint32_t)0x00020000))>65535L)) >>8*(((((uint32_t)0x00020000))*1L >>16*((((uint32_t)0x00020000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00020000))*1L >>16*((((uint32_t)0x00020000))>65535L)) >>8*(((((uint32_t)0x00020000))*1L >>16*((((uint32_t)0x00020000))>65535L))>255))/2+1))))), ENABLE);
    RCC_ClockCmd((((RCC_AHB) << 5) | (16*((((uint16_t)0x0001))>65535L) + (8*(((((uint16_t)0x0001))*1L >>16*((((uint16_t)0x0001))>65535L))>255) + (8 - 90/(((((((uint16_t)0x0001))*1L >>16*((((uint16_t)0x0001))>65535L)) >>8*(((((uint16_t)0x0001))*1L >>16*((((uint16_t)0x0001))>65535L))>255))/4+14)|1) - 2/((((((uint16_t)0x0001))*1L >>16*((((uint16_t)0x0001))>65535L)) >>8*(((((uint16_t)0x0001))*1L >>16*((((uint16_t)0x0001))>65535L))>255))/2+1))))), ENABLE);



    if (options & SERIAL_BIDIR) {
        IOInit(IOGetByTag(((((0) + 1) << 4) | (2))), OWNER_SERIAL, RESOURCE_UART_TXRX, 2);
        IOConfigGPIO(IOGetByTag(((((0) + 1) << 4) | (2))), ((GPIO_Mode_AF_OD) | (GPIO_Speed_2MHz)));
    } else {
        if (mode & MODE_TX) {
            IOInit(IOGetByTag(((((0) + 1) << 4) | (2))), OWNER_SERIAL, RESOURCE_UART_TX, 2);
            IOConfigGPIO(IOGetByTag(((((0) + 1) << 4) | (2))), ((GPIO_Mode_AF_PP) | (GPIO_Speed_2MHz)));
        }

        if (mode & MODE_RX) {
            IOInit(IOGetByTag(((((0) + 1) << 4) | (3))), OWNER_SERIAL, RESOURCE_UART_RX, 2);
            IOConfigGPIO(IOGetByTag(((((0) + 1) << 4) | (3))), ((GPIO_Mode_IPU) | (GPIO_Speed_2MHz)));
        }
    }
