...
# 59 "./src/main/drivers/bus_i2c_stm32f10x.c"
#define I2C1_SCL PB6
...
# 85 "./src/main/drivers/bus_i2c_stm32f10x.c"
typedef enum {
    I2C_STATE_STOPPED = 0,
    I2C_STATE_STOPPING,
    I2C_STATE_STARTING,
...
_Bool i2cWriteBuffer(I2CDevice device, uint8_t addr, uint8_t reg, uint8_t len, uint8_t * data)
{
...
_Bool i2cWrite(I2CDevice device, uint8_t addr, uint8_t reg, uint8_t data)
{
    return i2cWriteBuffer(device, addr, reg, 1, &data);
}

_Bool i2cRead(I2CDevice device, uint8_t addr, uint8_t reg, uint8_t len, uint8_t* buf)
{
