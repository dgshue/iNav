...
static IO_t m25p16CsPin = ((IO_t)0);
...
_Bool m25p16_init(ioTag_t csTag)
{
    ...
    if (csTag) {
        ...
        m25p16CsPin = IOGetByTag(((((1) + 1) << 4) | (12)));



    }
    IOInit(m25p16CsPin, OWNER_FLASH, RESOURCE_SPI_CS, 0);
    IOConfigGPIO(m25p16CsPin, ((GPIO_Mode_Out_PP) | (GPIO_Speed_50MHz)));
...
# 308 "./src/main/drivers/flash_m25p16.c"
void m25p16_pageProgram(uint32_t address, const uint8_t *data, int length)
{
...
# 325 "./src/main/drivers/flash_m25p16.c"
int m25p16_readBytes(uint32_t address, uint8_t *buffer, int length)
{
