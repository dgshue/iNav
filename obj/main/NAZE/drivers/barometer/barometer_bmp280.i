...
# 1 "./src/main/drivers/barometer/barometer_spi_bmp280.h" 1
# 18 "./src/main/drivers/barometer/barometer_spi_bmp280.h"
...
# 89 "./src/main/drivers/barometer/barometer_bmp280.c"
        _Bool ack = i2cRead((I2CDEV_2), (0x76), (0xD0), 1, &bmp280_chip_id);
        if (!ack || bmp280_chip_id != (0x58))
            continue;


        i2cRead((I2CDEV_2), (0x76), (0x88), 24, (uint8_t *)&bmp280_cal);

        i2cWrite((I2CDEV_2), (0x76), (0xF4), (((0x04)) << 2 | ((0x01)) << 5 | (0x01)));

        i2cWrite((I2CDEV_2), (0x76), (0xF5), ((0x03) << 2));
...
static void bmp280_get_up(void)
{
    ...
    _Bool ack = i2cRead((I2CDEV_2), (0x76), (0xF7), (6), data);
