...
# 21 "./src/main/sensors/barometer.h" 2
...
_Bool ms56xxDetect(baroDev_t *baro, baroSensor_e baroType);
# 28 "./src/main/drivers/barometer/barometer_ms56xx.c" 2
# 1 "./src/main/drivers/barometer/barometer_spi_ms56xx.h" 1
# 18 "./src/main/drivers/barometer/barometer_spi_ms56xx.h"
       

void ms56xxSpiInit(void);
_Bool ms56xxSpiReadCommand(uint8_t reg, uint8_t length, uint8_t *data);
_Bool ms56xxSpiWriteCommand(uint8_t reg, uint8_t data);
...
# 32 "./src/main/drivers/barometer/barometer_ms56xx.c" 2
...
static uint16_t ms56xx_prom(int8_t coef_num)
{
    ...
    i2cRead((I2CDEV_2), 0x77, 0xA0 + coef_num * 2, 2, rxbuf);
...
static uint32_t ms56xx_read_adc(void)
{
    ...
    i2cRead((I2CDEV_2), 0x77, 0x00, 3, rxbuf);
...
static void ms56xx_start_ut(void)
{
    ...
    i2cWrite((I2CDEV_2), 0x77, 0x40 + 0x10 + ms56xx_osr, 1);
...
static void ms56xx_start_up(void)
{
    ...
    i2cWrite((I2CDEV_2), 0x77, 0x40 + 0x00 + ms56xx_osr, 1);
...
# 212 "./src/main/drivers/barometer/barometer_ms56xx.c"
...
_Bool ms56xxDetect(baroDev_t *baro, baroSensor_e baroType)
{
    ...
    for (int retryCount = 0; retryCount < 5; retryCount++) {
        ...
        _Bool ack = i2cRead((I2CDEV_2), 0x77, 0xA0, 1, &sig);
        if (ack) {
...
# 255 "./src/main/drivers/barometer/barometer_ms56xx.c"
