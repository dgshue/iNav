...
static void usartConfigurePinInversion(uartPort_t *uartPort) {
    ...
    if (inverted) {
        ...
        enableInverter(uartPort->USARTx, 1);
    }
# 64 "./src/main/drivers/serial_uart.c"
}
...
serialPort_t *uartOpen(USART_TypeDef *USARTx, serialReceiveCallbackPtr rxCallback, uint32_t baudRate, portMode_t mode, portOptions_t options)
{
    ...
    } else if (USARTx == ((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800))) {
...
# 134 "./src/main/drivers/serial_uart.c"
    ...
    if (mode & MODE_RX) {
# 167 "./src/main/drivers/serial_uart.c"
        if (s->rxDMAChannel) {
...
# 190 "./src/main/drivers/serial_uart.c"
    ...
    if (mode & MODE_TX) {
# 221 "./src/main/drivers/serial_uart.c"
        if (s->txDMAChannel) {
            DMA_StructInit(&DMA_InitStructure);
...
void uartStartTxDMA(uartPort_t *s)
{
# 292 "./src/main/drivers/serial_uart.c"
...
# 349 "./src/main/drivers/serial_uart.c"
    if (s->txDMAChannel) {
...
# 364 "./src/main/drivers/serial_uart.c"
