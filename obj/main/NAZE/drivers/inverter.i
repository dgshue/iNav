...
static void inverterSet(IO_t pin, _Bool on)
{
    IOWrite(pin, on);
}
...
void initInverters(void)
{
    ...
    initInverter(((((1) + 1) << 4) | (2)));
# 69 "./src/main/drivers/inverter.c"
}
...
void enableInverter(USART_TypeDef *USARTx, _Bool on)
{
    ...
    IO_t pin = ((IO_t)0);
# 83 "./src/main/drivers/inverter.c"
    if (USARTx == ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400))) {
        pin = IOGetByTag(((((1) + 1) << 4) | (2)));
    }
# 112 "./src/main/drivers/inverter.c"
    inverterSet(pin, on);
