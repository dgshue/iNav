...
# 35 "./lib/main/CMSIS/CM3/CoreSupport/core_cm3.h" 2
...
static const IO_t leds[] = {
    ...
    (IO_t)(ioRecs + ((((((0xffff & ((1 << (3)) - 1)) - (((0xffff & ((1 << (3)) - 1))>>1)&0x77777777) - (((0xffff & ((1 << (3)) - 1))>>2)&0x33333333) - (((0xffff & ((1 << (3)) - 1))>>3)&0x11111111))+(((0xffff & ((1 << (3)) - 1)) - (((0xffff & ((1 << (3)) - 1))>>1)&0x77777777) - (((0xffff & ((1 << (3)) - 1))>>2)&0x33333333) - (((0xffff & ((1 << (3)) - 1))>>3)&0x11111111))>>4)) & 0x0F0F0F0F) % 255) + (((((0xffff) - (((0xffff)>>1)&0x77777777) - (((0xffff)>>2)&0x33333333) - (((0xffff)>>3)&0x11111111))+(((0xffff) - (((0xffff)>>1)&0x77777777) - (((0xffff)>>2)&0x33333333) - (((0xffff)>>3)&0x11111111))>>4)) & 0x0F0F0F0F) % 255))),
...
void ledInit(_Bool alternative_led)
{
    ...
    for (int i = 0; i < 3; i++) {
        if (leds[i + ledOffset]) {
            ...
            IOConfigGPIO(leds[i + ledOffset], ((GPIO_Mode_Out_PP) | (GPIO_Speed_2MHz)));
        }
    }
...
void ledSet(int led, _Bool on)
{
    const _Bool inverted = (1 << (led + ledOffset)) & ledPolarity;
