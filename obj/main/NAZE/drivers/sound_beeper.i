...
static IO_t beeperIO = (IO_t)((void *)0);
static _Bool beeperInverted = 0;
static _Bool beeperState = 0;
...
void beeperInit(const beeperDevConfig_t *config)
{
    ...
    if (beeperIO) {
        ...
        IOConfigGPIO(beeperIO, config->isOD ? ((GPIO_Mode_Out_OD) | (GPIO_Speed_2MHz)) : ((GPIO_Mode_Out_PP) | (GPIO_Speed_2MHz)));
