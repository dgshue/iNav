...
void mpu6500GyroInit(gyroDev_t *gyro)
{
    ...
    delay(15);
    gyro->mpuConfiguration.writeFn(&gyro->bus, 0x1C, INV_FSR_8G << 3);
    delay(15);
    ...
    gyro->mpuConfiguration.writeFn(&gyro->bus, 0x37, 0 << 7 | 0 << 6 | 0 << 5 | 1 << 4 | 0 << 3 | 0 << 2 | 0 << 1 | 0 << 0);

    delay(15);


    gyro->mpuConfiguration.writeFn(&gyro->bus, 0x38, 0x01);
