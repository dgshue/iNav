...
# 34 "./src/main/drivers/accgyro/accgyro_mpu6050.c" 2
...
# 19 "./src/main/drivers/gyro_sync.h" 2
...
# 36 "./src/main/drivers/accgyro/accgyro_mpu6050.c" 2
...
# 41 "./src/main/drivers/accgyro/accgyro_mpu6050.c" 2
...
static void mpu6050GyroInit(gyroDev_t *gyro)
{
    ...
    _Bool ack = gyro->mpuConfiguration.writeFn(&gyro->bus, 0x6B, 0x80);
    delay(100);
    ack = gyro->mpuConfiguration.writeFn(&gyro->bus, 0x6B, 0x03);
    ack = gyro->mpuConfiguration.writeFn(&gyro->bus, 0x19, gyroMPU6xxxGetDividerDrops(gyro));
    delay(15);
    ack = gyro->mpuConfiguration.writeFn(&gyro->bus, 0x1A, gyro->lpf);
    ack = gyro->mpuConfiguration.writeFn(&gyro->bus, 0x1B, INV_FSR_2000DPS << 3);



    ack = gyro->mpuConfiguration.writeFn(&gyro->bus, 0x1C, INV_FSR_8G << 3);

    ack = gyro->mpuConfiguration.writeFn(&gyro->bus, 0x37,
            0 << 7 | 0 << 6 | 0 << 5 | 0 << 4 | 0 << 3 | 0 << 2 | 1 << 1 | 0 << 0);


    ack = gyro->mpuConfiguration.writeFn(&gyro->bus, 0x38, (1 << 0));
