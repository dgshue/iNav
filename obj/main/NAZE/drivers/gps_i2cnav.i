# 1 "./src/main/drivers/gps_i2cnav.c"
# 1 "/home/vagrant/iNav//"
# 1 "<built-in>"
#define __STDC__ 1
...
# 1 "./src/main/drivers/gps_i2cnav.c"
# 18 "./src/main/drivers/gps_i2cnav.c"
...
# 19 "./src/main/drivers/gps_i2cnav.c" 2
...
# 20 "./src/main/drivers/gps_i2cnav.c" 2
...
# 22 "./src/main/drivers/gps_i2cnav.c" 2
...
# 24 "./src/main/drivers/gps_i2cnav.c" 2


# 1 "./src/main/drivers/gps_i2cnav.h" 1
# 18 "./src/main/drivers/gps_i2cnav.h"
...
_Bool i2cnavGPSModuleDetect(void);
void i2cnavGPSModuleRead(gpsDataI2CNAV_t * gpsMsg);
# 27 "./src/main/drivers/gps_i2cnav.c" 2
...
# 29 "./src/main/drivers/gps_i2cnav.c" 2
...
# 30 "./src/main/drivers/gps_i2cnav.c" 2
...
# 31 "./src/main/drivers/gps_i2cnav.c" 2
...
#define I2C_GPS_REG_VERSION 03
#define I2C_GPS_LOCATION 07
#define I2C_GPS_GROUND_SPEED 31
#define I2C_GPS_ALTITUDE 33
#define I2C_GPS_GROUND_COURSE 35
#define I2C_GPS_TIME 39
...
_Bool i2cnavGPSModuleDetect(void)
{
    ...
    ack = i2cRead(I2CDEV_1, 0x20, 00, 1, &i2cGpsStatus);
...
void i2cnavGPSModuleRead(gpsDataI2CNAV_t * gpsMsg)
{
    ...
    uint8_t i2cGpsStatus;
    _Bool ack = i2cRead(I2CDEV_1, 0x20, 00, 1, &i2cGpsStatus);
    ...
    if (i2cGpsStatus & 0x04) {
        gpsMsg->flags.fix3D = 1;

        if (i2cGpsStatus & 0x01) {
            i2cRead(I2CDEV_1, 0x20, 07, 4, (uint8_t*)&gpsMsg->latitude);
            i2cRead(I2CDEV_1, 0x20, 07 + 4, 4, (uint8_t*)&gpsMsg->longitude);
            i2cRead(I2CDEV_1, 0x20, 31, 2, (uint8_t*)&gpsMsg->speed);
            i2cRead(I2CDEV_1, 0x20, 35, 2, (uint8_t*)&gpsMsg->ground_course);
            i2cRead(I2CDEV_1, 0x20, 33, 2, (uint8_t*)&gpsMsg->altitude);
