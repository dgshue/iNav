...
# 30 "./src/main/drivers/adc_stm32f10x.c" 2
...
typedef enum ADCDevice {
    ADCINVALID = -1,
    ADCDEV_1 = 0,
# 42 "./src/main/drivers/adc_impl.h"
    ADCDEV_MAX = ADCDEV_1,
...
static adcDevice_t adcHardware[ADCDEV_COUNT] = {
    { .ADCx = ((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)), .rccADC = (((RCC_APB2) << 5) | (16*((((uint32_t)0x00000200))>65535L) + (8*(((((uint32_t)0x00000200))*1L >>16*((((uint32_t)0x00000200))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00000200))*1L >>16*((((uint32_t)0x00000200))>65535L)) >>8*(((((uint32_t)0x00000200))*1L >>16*((((uint32_t)0x00000200))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00000200))*1L >>16*((((uint32_t)0x00000200))>65535L)) >>8*(((((uint32_t)0x00000200))*1L >>16*((((uint32_t)0x00000200))>65535L))>255))/2+1))))), .rccDMA = (((RCC_AHB) << 5) | (16*((((uint16_t)0x0001))>65535L) + (8*(((((uint16_t)0x0001))*1L >>16*((((uint16_t)0x0001))>65535L))>255) + (8 - 90/(((((((uint16_t)0x0001))*1L >>16*((((uint16_t)0x0001))>65535L)) >>8*(((((uint16_t)0x0001))*1L >>16*((((uint16_t)0x0001))>65535L))>255))/4+14)|1) - 2/((((((uint16_t)0x0001))*1L >>16*((((uint16_t)0x0001))>65535L)) >>8*(((((uint16_t)0x0001))*1L >>16*((((uint16_t)0x0001))>65535L))>255))/2+1))))), .DMAy_Channelx = ((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0008)), .enabled = 0, .usedChannelCount = 0 }
};
...
static void adcInstanceInit(ADCDevice adcDevice)
{
    ...
    DMA_InitStructure.DMA_MemoryInc = adc->usedChannelCount > 1 ? ((uint32_t)0x00000080) : ((uint32_t)0x00000000);
