...
_Bool i2c_OLED_send_byte(uint8_t val);
void i2c_OLED_clear_display(void);
void i2c_OLED_clear_display_quick(void);
# 27 "./src/main/drivers/display_ug2864hsweg01.c" 2
...
{
    return i2cWrite(I2CDEV_1, 0x3C, 0x80, command);
}

_Bool i2c_OLED_send_byte(uint8_t val)
{
    return i2cWrite(I2CDEV_1, 0x3C, 0x40, val);
}
