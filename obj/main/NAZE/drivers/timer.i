...
void timerConfigure(const timerHardware_t *timerHardwarePtr, uint16_t period, uint8_t mhz)
{
    ...
    timerNVICConfigure(irq, (((((1)<<(4-(7-(((uint32_t)0x500)>>8))))|((1)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0));


    switch (irq) {

    case TIM1_CC_IRQn:
        timerNVICConfigure(TIM1_UP_IRQn, (((((1)<<(4-(7-(((uint32_t)0x500)>>8))))|((1)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0));
        break;
# 283 "./src/main/drivers/timer.c"
    }
}
