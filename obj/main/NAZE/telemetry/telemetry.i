...
_Bool checkCrsfTelemetryState(void);
...
const telemetryConfig_t pgResetTemplate_telemetryConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .telemetry_inversion = 0, .telemetry_switch = 0, .gpsNoFixLatitude = 0, .gpsNoFixLongitude = 0, .frsky_coordinate_format = FRSKY_FORMAT_DMS, .frsky_unit = FRSKY_UNIT_METRICS, .frsky_vfas_precision = 0, .frsky_vfas_cell_voltage = 0, .hottAlarmSoundInterval = 5, .smartportUartUnidirectional = 0, .smartportFuelPercent = 0, .ibusTelemetryType = 0, .ltmUpdateRate = LTM_RATE_NORMAL }
# 74 "./src/main/telemetry/telemetry.c"
 ;
...
void telemetryInit(void)
{
    ...
    initFrSkyTelemetry();
# 91 "./src/main/telemetry/telemetry.c"
    initLtmTelemetry();
...
serialPort_t *telemetrySharedPort = ((void *)0);
...
# 167 "./src/main/telemetry/telemetry.c"
}
...
# 186 "./src/main/telemetry/telemetry.c"
    handleLtmTelemetry();
# 204 "./src/main/telemetry/telemetry.c"
}
