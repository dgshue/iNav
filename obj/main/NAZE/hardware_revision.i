...
# 34 "./src/main/target/NAZE/hardware_revision.c" 2
...
# 36 "./src/main/target/NAZE/hardware_revision.c" 2
...
# 38 "./src/main/target/NAZE/hardware_revision.c" 2
...
uint8_t detectSpiDevice(void)
{
    ...
    nazeSpiCsPin = IOGetByTag(((((1) + 1) << 4) | (12)));
