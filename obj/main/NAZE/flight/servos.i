...
{
    for (int i = 0; i < 8; i++) {
        static const const servoParam_t _reset_template_83 = { .min = 1000, .max = 2000, .middle = 1500, .rate = 100, .forwardFromChannel = (uint8_t)0xFF }; memcpy((&instance[i]), &_reset_template_83, sizeof(*(&instance[i])));
...
const mixerRules_t servoMixers[] = {
    { 0, 0, 0, ((void *)0) },
    { (sizeof(servoMixerTri) / sizeof(servoMixer_t)), SERVO_RUDDER, SERVO_RUDDER, servoMixerTri },
    { 0, 0, 0, ((void *)0) },
    { 0, 0, 0, ((void *)0) },
    { 0, 0, 0, ((void *)0) },
    { 0, 0, 0, ((void *)0) },
    { 0, 0, 0, ((void *)0) },
    { 0, 0, 0, ((void *)0) },
    { (sizeof(servoMixerFlyingWing) / sizeof(servoMixer_t)), SERVO_FLAPPERON_1, SERVO_FLAPPERON_2, servoMixerFlyingWing },
    { 0, 0, 0, ((void *)0) },
    { 0, 0, 0, ((void *)0) },
    { 0, 0, 0, ((void *)0) },
    { 0, 0, 0, ((void *)0) },
    { 0, 0, 0, ((void *)0) },
    { (sizeof(servoMixerAirplane) / sizeof(servoMixer_t)), SERVO_ELEVATOR, SERVO_RUDDER, servoMixerAirplane },
    { 0, 0, 0, ((void *)0) },
    { 0, 0, 0, ((void *)0) },
    { 0, 0, 0, ((void *)0) },
    { 0, 0, 0, ((void *)0) },
    ...
    { 0, 0, 0, ((void *)0) },
    { 0, 2, 5, ((void *)0) },
    { 0, SERVO_ELEVATOR, SERVO_RUDDER, ((void *)0) },
    { 0, SERVO_RUDDER, SERVO_RUDDER, ((void *)0) },
};
...
void writeServos(void)
{
    ...
    _Bool zeroServoValue = 0;




    const mixerMode_e currentMixerMode = mixerConfig()->mixerMode;
    if ((currentMixerMode == MIXER_TRI || currentMixerMode == MIXER_CUSTOM_TRI) && !(armingFlags & (ARMED)) && !servoConfig()->tri_unarmed_servo) {
        zeroServoValue = 1;
    }
