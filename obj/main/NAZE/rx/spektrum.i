...
static IO_t BindPin = (IO_t)((void *)0);
...
void spektrumBind(rxConfig_t *rxConfig)
{
    ...
    IOConfigGPIO(BindPin, ((GPIO_Mode_Out_PP) | (GPIO_Speed_2MHz)));
...
_Bool spektrumInit(const rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig)
{
    ...
    _Bool portShared = telemetryCheckRxPortShared(portConfig);
