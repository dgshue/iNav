...
# 23 "./src/main/target/NAZE/target.c" 2
...
const timerHardware_t timerHardware[14] = {
    { ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), ((((0) + 1) << 4) | (0)), ((uint16_t)0x0000), 0, ((GPIO_Mode_IPD) | (GPIO_Speed_2MHz)), TIM_USE_PPM | TIM_USE_PWM},
    { ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), ((((0) + 1) << 4) | (1)), ((uint16_t)0x0004), 0, ((GPIO_Mode_IPD) | (GPIO_Speed_2MHz)), TIM_USE_PWM },
    { ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), ((((0) + 1) << 4) | (2)), ((uint16_t)0x0008), 0, ((GPIO_Mode_IPD) | (GPIO_Speed_2MHz)), TIM_USE_PWM },
    { ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), ((((0) + 1) << 4) | (3)), ((uint16_t)0x000C), 0, ((GPIO_Mode_IPD) | (GPIO_Speed_2MHz)), TIM_USE_PWM },
    { ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400)), ((((0) + 1) << 4) | (6)), ((uint16_t)0x0000), 0, ((GPIO_Mode_IPD) | (GPIO_Speed_2MHz)), TIM_USE_PWM | TIM_USE_MC_CHNFW },
    { ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400)), ((((0) + 1) << 4) | (7)), ((uint16_t)0x0004), 0, ((GPIO_Mode_IPD) | (GPIO_Speed_2MHz)), TIM_USE_PWM | TIM_USE_MC_CHNFW },
    { ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400)), ((((1) + 1) << 4) | (0)), ((uint16_t)0x0008), 0, ((GPIO_Mode_IPD) | (GPIO_Speed_2MHz)), TIM_USE_PWM | TIM_USE_MC_CHNFW },
    { ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400)), ((((1) + 1) << 4) | (1)), ((uint16_t)0x000C), 0, ((GPIO_Mode_IPD) | (GPIO_Speed_2MHz)), TIM_USE_PWM | TIM_USE_MC_CHNFW },

    { ((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2C00)), ((((0) + 1) << 4) | (8)), ((uint16_t)0x0000), 1, ((GPIO_Mode_IPD) | (GPIO_Speed_2MHz)), TIM_USE_MC_MOTOR | TIM_USE_MC_SERVO | TIM_USE_FW_MOTOR },
    { ((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2C00)), ((((0) + 1) << 4) | (11)), ((uint16_t)0x000C), 1, ((GPIO_Mode_IPD) | (GPIO_Speed_2MHz)), TIM_USE_MC_MOTOR | TIM_USE_MC_SERVO | TIM_USE_FW_MOTOR },
    { ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0800)), ((((1) + 1) << 4) | (6)), ((uint16_t)0x0000), 0, ((GPIO_Mode_IPD) | (GPIO_Speed_2MHz)), TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO },
    { ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0800)), ((((1) + 1) << 4) | (7)), ((uint16_t)0x0004), 0, ((GPIO_Mode_IPD) | (GPIO_Speed_2MHz)), TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO },
    { ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0800)), ((((1) + 1) << 4) | (8)), ((uint16_t)0x0008), 0, ((GPIO_Mode_IPD) | (GPIO_Speed_2MHz)), TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO },
    { ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0800)), ((((1) + 1) << 4) | (9)), ((uint16_t)0x000C), 0, ((GPIO_Mode_IPD) | (GPIO_Speed_2MHz)), TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO }
};
